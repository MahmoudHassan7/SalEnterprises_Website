...
<head>
  <meta charset="UTF-8">
      <link rel="shortcut icon" type="image/x-icon" href="images/logos/MS-logo.png">

  <title>SULTAN AHMED LOOTAH ENTERPRISES</title>
...
<link rel="stylesheet" href="css/land-page.css">
 <style>
  ...
  .curved-button:active {
    background-color: crimson; /* Different color on click */
...
<main>
  <section class="advice">
     <div class="logo">
            <img src="images/logos/sal_white.png" alt="MS LOOTAH Logo">
        </div>
    <h1 class="advice__title">We're Building Something Great!</h1>
     <div class="contact">
            <p>For inquiries, please contact us at: <a href="mailto:contact@mslootah.ae">info@salenterprises.ae</a></p>
         </div>
